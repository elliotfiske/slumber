...
void initGL()
{
	...
	shadowbuffer.generate();
	bool buffer_status = shadowbuffer.generateTexture(shadowmap_width, shadowmap_height);
	if (!buffer_status) {
...
void drawGL()
{
	...
	shadowbuffer.bindTexture(prog_pass2.getUniform("shadowMap"));
